...
DBP70_utuva_mean <- mean(article1utuva$utuva1dbp, na.rm = T)
DBP70_utuva_mean

DBP70_utuva_upper <- ci_95_upper(article1utuva$utuva1dbp)
DBP70_utuva_upper


# UTUVA 2
  
DBP75_utuva_mean <- mean(article1utuva$utuva2dbp, na.rm = T)
DBP75_utuva_mean

DBP75_utuva_upper <- ci_95_upper(article1utuva$utuva2dbp)
DBP75_utuva_upper


# UTUVA 3
  
DBP80_utuva_mean <- mean(article1utuva$utuva3dbp, na.rm = T)
DBP80_utuva_mean

DBP80_utuva_upper <- ci_95_upper(article1utuva$utuva3dbp)
DBP80_utuva_upper
...
tibble::tribble(
  ~Age,       ~Cohort,                 ~DBP_mean,        ~upperCI,
   tuva1age,  "1920-born TUVA cohort",  DBP70_tuva_mean,  DBP70_tuva_upper,
   tuva2age,  "1920-born TUVA cohort",  DBP80_tuva_mean,  DBP80_tuva_upper,
   tuva3age,  "1920-born TUVA cohort",  DBP85_tuva_mean,  DBP85_tuva_upper,
   tuva4age,  "1920-born TUVA cohort",  DBP90_tuva_mean,  DBP90_tuva_upper,
   tuva5age,  "1920-born TUVA cohort",  DBP95_tuva_mean,  DBP95_tuva_upper,
  utuva1age, "1940-born UTUVA cohort", DBP70_utuva_mean,   DBP70_utuva_upper,
  utuva2age, "1940-born UTUVA cohort", DBP75_utuva_mean,   DBP75_utuva_upper,
  utuva3age, "1940-born UTUVA cohort", DBP80_utuva_mean,   DBP80_utuva_upper
  )
...
ggsave("Fig1_DBP_dpi600_revision.pdf", fig1, width = 7, height =5, dpi = 600)


# Load that pdf file with the magick package
pdf_image <- magick::image_read_pdf("Fig1_DBP_dpi600_revision.pdf", density = 600)

# Save it as PNG
image_write(pdf_image,
            path = "Fig1_DBP_dpi600_revision.png",
            format = "png",
            density = 600)
